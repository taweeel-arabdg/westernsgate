    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 md:py-24 overflow-hidden">
        <div className="container mx-auto px-4" dir="rtl">
          ...
          <div className="flex items-center gap-6 mb-8 animate-[scroll-rtl_10s_linear_infinite]">
          ...
          <div className="flex items-center gap-6 animate-[scroll-ltr_10s_linear_infinite]">
